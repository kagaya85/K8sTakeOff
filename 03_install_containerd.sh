...
yum -y install systemd-devel systemd-libs libseccomp libseccomp-devel device-mapper-libs
...
[plugins]
  ...
  [plugins."io.containerd.grpc.v1.cri"]
    ...
    sandbox_image = "registry.cn-hangzhou.aliyuncs.com/kagaya/pause:3.2"
